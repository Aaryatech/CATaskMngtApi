...
public interface EmployeeListWithAvailableHoursRepo extends JpaRepository<EmployeeListWithAvailableHours, Integer> {
	...
	@Query(value = "select\n" + 
			...
			"                and l.leave_todt<=:toDate\n" + 
			"            )\n" + 
			"        ) and e.emp_id=:ids", nativeQuery = true)
	List<EmployeeListWithAvailableHours> getLeaveRecordByEmpIdSac(@Param("fromDate")String fromDate,@Param("toDate") String toDate,@Param("ids")  int ids);
	...
	@Query(value = "select\n" + 
			...
			"            )\n" + 
			"        ) and e.emp_id in (:ids)", nativeQuery = true)
	List<EmployeeListWithAvailableHours> getLeaveRecordCommon(@Param("fromDate")String fromDate,@Param("toDate") String toDate,@Param("ids")  List<Integer> ids);
